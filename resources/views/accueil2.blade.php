  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption d-none d-md-block">
          <a href="{{route('catalogue', ['filtre' => 'promotions'])}}" class="btn-lg btn-primary mr-auto mt-3 mb-5">Profiter des promotions du moments !</a>
      </div>
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="/public/img/slider2.jpg" alt="Second slide">
        <div class="carousel-caption d-none d-md-block">
          <a href="{{ route('recommandations') }}" class="btn-lg btn-primary mr-auto mt-3 mb-5">Découvrer notre séléction de recommandations !</a>
      </div>
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="/public/img/slider3.jpg" alt="Third slide">
      <div class="carousel-caption d-none d-md-block">
          <a href="{{ route('carton-decouverte') }}" class="btn-lg btn-primary mr-auto mt-3 mb-5">Tester notre carton découverte !</a>
      </div>
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="/public/img/slider4.jpg" alt="Second slide">
      <div class="carousel-caption d-none d-md-block">
          <a href="{{route('catalogue', ['filtre' => 'nouveautes'])}}" class="btn-lg btn-primary mr-auto mt-3 mb-5">Jeter un oeil aux nouveautés !</a>
      </div>
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="/public/img/slider1.jpg" alt="Third slide">
      <div class="carousel-caption d-none d-md-block">
          <a href="{{route('catalogue', ['filtre' => 'bios'])}}" class="btn-lg btn-primary mr-auto mt-3 mb-5">Envie d'étancher votre soif de vins bio ?</a>
      </div>
    </div>
